...
class surgeryscreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _surgeryscreen();
  }
}

class _surgeryscreen extends State<surgeryscreen> {
  int num = 20;
  List  id =[];
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<changedata>(context, listen: false).getpatientsurgery();
    });
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
              ...
              child: Consumer<changedata>(builder: (context, val, child) {
                return GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 4),
                    itemCount: val.listpatientsurgery.length,
                    itemBuilder: (context, i) {
                      val.displaypatient(i);
                      //id.add(int.parse(val.listpatientsurgery[i].idpatient));
                      return Container(
                            ...
                            return MaterialButton(
                              ...
                              onPressed: () {
                                ...
                                val.getidpatient(int.parse(
                                    val.listpatientsurgery[i].idpatient));
